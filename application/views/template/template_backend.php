...
<head>
    ...
    <link href="<?= base_url() ?>/assets/sb-admin2/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>/dashboard">
                <div class="sidebar-brand-text">SIMFOR GEREJA</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <?= ucwords($this->session->userdata('username_aktif')); ?> </p>
                                <img class="img-profile rounded-circle"
                                    src="<?=base_url()?>assets/sb-admin2/img/<?= $this->session->userdata('gambar_aktif') ? $this->session->userdata('gambar_aktif') : '' ?>">
                            </a>
                        ...
                        <div class="container-fluid">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body fluid">
                                    <!-- <div class="text-area fluid"> -->
                                    <?php $this->load->view($main_container) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SIMFOR GKI Harapan <?= date ('Y') ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
