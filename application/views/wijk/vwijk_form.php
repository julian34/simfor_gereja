                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group row">
                                            <label class="control-label col-md-3">Nama Wijk
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-5">
                                                <input type="text" name="nama_wijk" data-required="1" placeholder="Nama Wijk..." value="<?= set_value('nama_wijk', isset($form_value['nama_wijk']) ? $form_value['nama_wijk'] : '') ?>" class="form-control input-height" />
                                                <span class="help-inline"><?php echo form_error('nama_wijk', '<div class="help-inline red">', '</div>'); ?></span>
                                            </div>
                                        </div>
