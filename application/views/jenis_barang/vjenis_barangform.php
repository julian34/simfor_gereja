                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group row">
                                            <label class="control-label col-md-3">Jenis Barang
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-5">
                                                <input type="text" name="nama_jenisbarang" data-required="1" placeholder="Jenis Barang..." value="<?= set_value('nama_jenisbarang', isset($form_value['nama_jenisbarang']) ? $form_value['nama_jenisbarang'] : '') ?>" class="form-control input-height" />
                                                <span class="help-inline"><?php echo form_error('nama_jenisbarang', '<div class="help-inline red">', '</div>'); ?></span>
                                            </div>
                                        </div>
